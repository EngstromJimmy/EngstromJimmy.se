---
title: Announcing Blazm (Grid component)
...
There are so many developers already doing that like Telerik, DevExpress, Syncfusion and many more.
...
Check out the source code [here](https://github.com/EngstromJimmy/Blazm/)

The company me and my wife run is called Azm Dev (Awesome dev).
Blazor + Azm == Blazm and it will make your site blazm (blossom).
I know.. I like puns.

I would love to know what functions (if any) you are missing =)
